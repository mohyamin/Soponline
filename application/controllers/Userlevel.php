...
class Userlevel extends MY_Controller
{
    ...
    public function index()
    {
        ...
        //     'fitur'   => "Menu Level User",
        //     'keterangan'  => "Melihat Data Level User",
    ...
    public function insert()
    {
        ...
        $savelog = array(
            'id_user'   => $this->session->userdata('id_user'),
            'fitur'   => "Level User",
            'keterangan'  => "Menambahkan Data Level User",
            'cretead_at'  => date('Y-m-d H:i:s'),
            'update_at'  => date('Y-m-d H:i:s')
    ...
    public function update()
    {
        ...
        $savelog = array(
            'id_user'   => $this->session->userdata('id_user'),
            'fitur'   => "Level User",
            'keterangan'  => "Merubah Data Level User",
            'cretead_at'  => date('Y-m-d H:i:s'),
            'update_at'  => date('Y-m-d H:i:s')
    ...
    public function delete()
    {
        ...
        $savelog = array(
            'id_user'   => $this->session->userdata('id_user'),
            'fitur'   => "Level User",
            'keterangan'  => "Menghapus Data Level User",
            'cretead_at'  => date('Y-m-d H:i:s'),
            'update_at'  => date('Y-m-d H:i:s')
