            ...
            <div class="card">
              <div class="card-header bg-light">
                ...
                <div class="text-right">
                  <a href="<?php echo site_url('user/download'); ?>" class="btn btn-success btn-sm">
                    Export Excel
                  </a>
      ...
      function edit_user(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            $('[name="level"]').val(data.id_level).trigger('change');
                  ...
                  <div class="col-sm-9 kosong">
                    <select class="form-control" name="level" id="level">
                      ...
                      foreach ($user_level as $level) {
                        if ($level->nama_level == 'Administrator') continue; // Sembunyikan
                      ?>
