        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title ">View Internal</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $("#tabelcompliance").DataTable({
                ...
                "autoWidth": false,
                "language": {
                    "sEmptyTable": "Data Intrnal Belum Ada"
                },
                ...
                "ajax": {
                    "url": "<?php echo site_url('internalviewer/ajax_list') ?>",
                    "type": "POST"
                },
        ...
        function vcompliance(id) {
            ...
            $('.modal-title').text('View internal');
            $("#modal-default").modal('show');
            $.ajax({
                url: '<?php echo base_url('internal/viewcompliance'); ?>',
                type: 'post',
                data: 'table=ketentuan_inter&id=' + id,
