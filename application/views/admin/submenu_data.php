  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Are you sure you want to delete the submenu <strong class="text-konfirmasi"> </strong> ?</p>
      </div>
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="card-body">
            ...
            <div class="form-group row ">
              <label for="nama_submenu" class="col-sm-3 col-form-label">Submenu Name</label>
              <div class="col-sm-9 kosong">
                <input type="text" class="form-control" name="nama_submenu" id="nama_submenu" placeholder="Submenu Name">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group row ">
            ...
            <div class="form-group row ">
              ...
              <div class="col-sm-9 kosong">
                <select class="form-control" name="is_active" id="is_active">
                  <option value="" selected disabled>Choose Active</option>
