      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>Are you sure you want to delete the menu <strong class="text-konfirmasi"> </strong> ?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" data-dismiss="modal">Cancel</button>
            ...
            <form action="#" id="form" class="form-horizontal">
              ...
              <div class="card-body">
                <div class="form-group row ">
                  <label for="nama_menu" class="col-sm-3 col-form-label">Menu Name</label>
                  <div class="col-sm-9 kosong">
                    <input type="text" class="form-control" name="nama_menu" id="nama_menu" placeholder="Name Menu">
                  </div>
                </div>
                <div class="form-group row ">
                ...
                <div class="form-group row ">
                  <label for="urutan" class="col-sm-3 col-form-label">Order</label>
                  <div class="col-sm-9 kosong">
                    <input type="text" class="form-control" name="urutan" id="urutan" placeholder="Order">
                  </div>
                </div>
                <div class="form-group row ">
