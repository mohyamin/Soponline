...
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-default navbar-dark navbar-info">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
  ...
  <style>
    .main-sidebar {
      ...
      /* penuh layar */
      overflow-y: auto;
      /* sidebar bisa scroll sendiri kalau panjang */
      z-index: 1038;
  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <!-- <img src="<?php echo base_url('uploads/profile/' . $this->session->userdata('image')); ?>" class="img-circle" alt="User Image" width="30" height="30"> -->
        <span class="ml-2 text-bold"><?php echo $this->session->userdata('full_name'); ?></span>
      </a>
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
        <a class="dropdown-item" href="<?php echo site_url('profile'); ?>">
          <i class="fas fa-user mr-2"></i> My Profile
        </a>
        <a class="dropdown-item" href="<?php echo site_url('change'); ?>">
...
<aside class="main-sidebar sidebar-dark-info  elevation-4">
  ...
  <a href="<?php echo base_url('dashboard'); ?>" class="brand-link navbar-info">
    <img src="<?php echo base_url(); ?>assets/foto/logo/<?php echo $apl->logo; ?>" alt="<?php echo $apl->title; ?>" class="brand-image" width="200" height="200">
